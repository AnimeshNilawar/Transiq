    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">
            Settlement {settlement.settlementReference}
          </h1>
        </div>
      </div>
      ...
      <div className="rounded-lg border p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <Item label="Settlement Reference" value={settlement.settlementReference} />
          <Item label="Amount" value={formatAmount(settlement.amount, settlement.currency)} />
          <Item label="Currency" value={settlement.currency} />
          <Item label="Bank Reference" value={settlement.bankReference} />
