    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <Item label="Refund Reference" value={refund.refundReference} />
          <Item label="Payment Reference" value={refund.paymentReference} />
          <Item label="Amount" value={formatAmount(refund.amount)} />
