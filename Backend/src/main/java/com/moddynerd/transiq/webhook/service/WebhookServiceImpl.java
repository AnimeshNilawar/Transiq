...
public class WebhookServiceImpl implements WebhookService {
    ...
    public CreateWebhookResponse createWebhook(CreateWebhookRequest request) {
        ...
        return createWebhook(merchant, request);
    }

    @Override
    public CreateWebhookResponse createWebhook(Merchant merchant, CreateWebhookRequest request) {
    ...
    public void disableWebhook(UUID webhookId) {
        Merchant merchant = currentApiKeyService.getCurrentPrincipal().merchant();
        disableWebhook(merchant, webhookId);
    }

    @Override
    public void disableWebhook(Merchant merchant, UUID webhookId) {
